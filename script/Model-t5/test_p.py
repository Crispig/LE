...
if __name__ == "__main__":
    ...
    model4.eval()
    model5.eval()
    f1 = open('../result/test-t5-large-1.txt','w')
    f2 = open('../result/test-t5-large-2.txt','w')
    f3 = open('../result/test-t5-large-3.txt','w')
    f4 = open('../result/test-t5-large-4.txt','w')
    f5 = open('../result/test-t5-large-all.txt','w')
    ft = open('../result/test-t5-large-tgt.txt','w')
