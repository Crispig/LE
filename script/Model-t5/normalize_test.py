...
path1 = "../combination/test-t5-large-1_final.txt"
path2 = "../combination/test-t5-large-2_final.txt"
path3 = "../combination/test-t5-large-3_final.txt"
path4 = "../combination/test-t5-large-4_final.txt"
path5 = "../combination/test-t5-large-all_final.txt"
...
with open("../model_ensembles/test-t5-large.txt",mode='w') as f:
