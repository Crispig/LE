...
f4 = None
f5 = None
with open('../result/test-t5-large-1.txt',mode='r') as f:
    f1 = f.readlines()
with open('../result/test-t5-large-2.txt',mode='r') as f:
    f2 = f.readlines()
with open('../result/test-t5-large-3.txt',mode='r') as f:
    f3 = f.readlines()
with open('../result/test-t5-large-4.txt',mode='r') as f:
    f4 = f.readlines()
with open('../result/test-t5-large-all.txt',mode='r') as f:
    f5 = f.readlines()
...
old_head = None
with open('../result/test-t5-large-tgt.txt',mode='r') as f:
    ft = f.readlines()
...
with open('../combination/test-t5-large-1_final.txt',mode='w') as f:
    for i in range(len(old_head)):
        f.write(str(result1_list[i]) + '\n')
with open('../combination/test-t5-large-2_final.txt',mode='w') as f:
    for i in range(len(old_head)):
        f.write(str(result2_list[i]) + '\n')
with open('../combination/test-t5-large-3_final.txt',mode='w') as f:
    for i in range(len(old_head)):
        f.write(str(result3_list[i]) + '\n')
with open('../combination/test-t5-large-4_final.txt',mode='w') as f:
    for i in range(len(old_head)):
        f.write(str(result4_list[i]) + '\n')
with open('../combination/test-t5-large-all_final.txt',mode='w') as f:
    for i in range(len(old_head)):
        f.write(str(result5_list[i]) + '\n')
with open('../combination/test-t5-large-tgt_final.txt',mode='w') as f:
    for i in range(len(old_head)):
