...
def main():
    ...
    parser.add_argument("--save_model",
                        default=False,
                        action='store_true',
                        help="if you need to save model")
    parser.add_argument("--load_model",
                        default=False,
                        action='store_true',
                        help="if you need to load model")
    parser.add_argument("--load_path",
                        default='./output',
                        type=str,
                        help="the path of Storage")
    ## Other parameters
    ...
    global_step = 0
    if args.load_model:
        print("========================================Loading pretrained model.......ing=============================================")
        model = torch.load(model,args.load_path+'/'+args.bert_model+args.data_dir+'.bin')
        ...
        for _ in range(int(args.num_train_epochs)):
            ...
            for inp, tgt in train_data.data_iter():
                ...
                if (global_step % args.num_log_steps == 0):
                    ...
                    nb_tr_examples = 0
    if args.save_model:
        torch.save(model,args.load_path+'/'+args.bert_model+'-4'+'.bin')
        print("==================================Model saved!=======================================")
