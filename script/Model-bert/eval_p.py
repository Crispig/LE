...
if __name__ == "__main__":
    ...
    model3.eval()
    model4.eval()
    f1 = open('../result/bert-base-uncased-1.txt','w')
    f2 = open('../result/bert-base-uncased-2.txt','w')
    f3 = open('../result/bert-base-uncased-3.txt','w')
    f4 = open('../result/bert-base-uncased-4.txt','w')
    ft = open('../result/bert-base-uncased-tgt.txt','w')
