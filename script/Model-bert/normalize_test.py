...
path1 = "../combination/test-bert-base-uncased-1_final.txt"
path2 = "../combination/test-bert-base-uncased-2_final.txt"
path3 = "../combination/test-bert-base-uncased-3_final.txt"
path4 = "../combination/test-bert-base-uncased-4_final.txt"
...
with open("../model_ensembles/test-bert-base-uncased.txt",mode='w') as f:
