...
#------------------------------------------------out[8,20,4,5]
        ...
        #         for x in range(4):
        #             temp=""
        #             for y in range(np.size(ops,3)):
        #                 if fc.search(ops[n,i,x,y]) == "[PAD]":
        #                     break

        #                 word=fc.search(ops[n,i,x,y])
        #                 if temp == "":
        #                    temp=word
        #                 elif "#" in fc.search(ops[n,i,x,y]):
        #                     temp=temp+fc.search(ops[n,i,x,y])[2:]
        #                 else:
        #                     temp=temp+"_"
        #                     temp=temp+word
        #             word1=fc.search(torch.argmax(k[n,i,:]))
        #             word2=temp 
        #             weight =duliang.correlation(word1,word2)
        #             out[n,i,x,0]+=0.05*weight
        ...
        #             word1=fc.search(torch.argmax(k[n,i,:]))
        #             for y in range(np.size(ops,3)):
        #                 word2=fc.search(ops[n,i,x,y])
        #                 weight=duliang.correlation(word1,word2)               
        #                 out[n,i,x,y]+=0.02*weight
