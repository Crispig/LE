...
if __name__ == "__main__":
    ...
    model3.eval()
    model4.eval()
    f1 = open('../result/test-albert-xxlarge-v2-1.txt','w')
    f2 = open('../result/test-albert-xxlarge-v2-2.txt','w')
    f3 = open('../result/test-albert-xxlarge-v2-3.txt','w')
    f4 = open('../result/test-albert-xxlarge-v2-4.txt','w')
    ft = open('../result/test-albert-xxlarge-v2-tgt.txt','w')
