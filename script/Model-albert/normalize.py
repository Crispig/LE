...
path1 = "../combination/albert-xxlarge-v2-1_final.txt"
path2 = "../combination/albert-xxlarge-v2-2_final.txt"
path3 = "../combination/albert-xxlarge-v2-3_final.txt"
path4 = "../combination/albert-xxlarge-v2-4_final.txt"
...
with open("../model_ensembles/albert-xxlarge-v2.txt",mode='w') as f:
