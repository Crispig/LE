...
if __name__ == "__main__":
    ...
    model1 = torch.load('../../model/albert-xxlarge-1.bin', map_location=torch.device('cpu'))
    model2 = torch.load('../../model/albert-xxlarge-2.bin', map_location=torch.device('cpu'))
    model3 = torch.load('../../model/albert-xxlarge-3.bin', map_location=torch.device('cpu'))
    model4 = torch.load('../../model/albert-xxlarge-4.bin', map_location=torch.device('cpu'))
    ...
    model3.eval()
    model4.eval()
    f1 = open('../result/albert-xxlarge-v2-1.txt','w')
    f2 = open('../result/albert-xxlarge-v2-2.txt','w')
    f3 = open('../result/albert-xxlarge-v2-3.txt','w')
    f4 = open('../result/albert-xxlarge-v2-4.txt','w')
    ft = open('../result/albert-xxlarge-v2-tgt.txt','w')

    tokenizer = AlbertTokenizer.from_pretrained('./pre_training/' + model_name + '/' + model_name + '.model')
    def eval(file='./ELE/dev/dev0056.json'):
        second_num = 0
    ...
    files = get_json_file_list('./ELE/dev')
    num=0
    for fi in files:
        eval(fi)
        num+=1
